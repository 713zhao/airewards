  ...
  Widget _buildFamilyTab() {
    return StreamBuilder<UserModel?>(
      ...
      builder: (context, snapshot) {
        ...
        final hasFamilyId = user?.familyId != null && user!.familyId!.isNotEmpty;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Share this ID with family members to let them join your family.',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        Text(
                          'Create a family to manage tasks and rewards together, or join an existing family.',
                          style: Theme.of(context).textTheme.bodyMedium,
                          textAlign: TextAlign.center,
                        ),
